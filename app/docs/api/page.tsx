...
// Build embed script URL from NEXT_PUBLIC env var, safely.
const EMBED_SCRIPT_URL =
  ((env.NEXT_PUBLIC_EMBED_URL as string) || "").replace(/\/$/, "") +
  "/embed.js";
...
/**
 * Generate snippet for each framework. All snippets use the single embed script URL
 * passed in via `scriptUrl`.
 */
...
<!-- End Konfigra Embed -->`;
    ...
    case "react":
      return `// React - functional component (CDN script loader)
...
`;
    default:
      // fallback to vanilla using the provided scriptUrl
      return generateFrameworkSnippet(
        "vanilla",
        publicKey,
        publicId,
        scriptUrl,
